...
export default function WomxnJoinClient() {
  ...
  const handleJoinGroup = async () => {
    ...
    try {
      const response = await fetch('/api/womxn-join', {
        method: 'POST',
  ...
  const handleRetry = () => { setStatus('ready'); setError(''); };
        ...
        return (
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <p className="font-sans text-base sm:text-lg text-slate-grey mb-4">{error}</p>
              <p className="font-sans text-sm text-slate-grey">
                Need access? Visit{' '}
                <a href="/womxn-whatsapp" className="text-umhc-green hover:underline font-medium">
                  the Womxn WhatsApp page
                </a>{' '}
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <p className="font-sans text-base sm:text-lg text-slate-grey mb-6 px-2">
                Your verification has been confirmed. Click the button below to join the UMHC Womxn WhatsApp group.
              </p>
            </div>

            <Button onClick={handleJoinGroup} className="px-8 py-3 text-lg" aria-describedby="womxn-join-help">
              Join Womxn WhatsApp Group
            </Button>
            <div id="womxn-join-help" className="sr-only">
              Clicking this button will redirect you to the Womxn WhatsApp group chat
            </div>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <p className="font-sans text-base sm:text-lg text-slate-grey mb-6">
                You&apos;re being redirected to the Womxn WhatsApp group...
              </p>
              {whatsappLink && (
                <div className="space-y-3">
                  <p className="font-sans text-sm text-slate-grey">If you&apos;re not redirected automatically:</p>
                  <a
                    href={whatsappLink}
        ...
        return (
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              ...
              <p className="font-sans text-base sm:text-lg text-slate-grey mb-6">{error}</p>
              <div className="space-y-3">
                <Button onClick={handleRetry} className="px-6 py-2 text-base">Try Again</Button>
                <p className="font-sans text-sm text-slate-grey">
                  Still having trouble? Request a new verification link at{' '}
                  <a href="/womxn-whatsapp" className="text-umhc-green hover:underline font-medium">
                    the Womxn WhatsApp page
                  </a>
                </p>
