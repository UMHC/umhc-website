            ...
            <div className="flex flex-col md:flex-row lg:flex-col items-center gap-5 md:gap-4 lg:gap-5 w-full justify-center">
              ...
              <div className="flex gap-4 md:gap-3 lg:gap-4 items-center shrink-0">
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="footer-tiktok-icon">
                    <title id="footer-tiktok-icon">TikTok</title>
                    <path 
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="footer-strava-icon">
                    <title id="footer-strava-icon">Strava</title>
                    <path 
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <svg className="w-full h-full" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="footer-whatsapp-icon">
                    <title id="footer-whatsapp-icon">WhatsApp</title>
                    <path 
